    ...
    ?>
   		...
   		<form action="text.php" method="post">
   			...
   			<!--<div class="col-sm-12" style="margin-bottom: 20px;">
   				<div class="col-sm-4 col-xs-4" align="right"> <span class="glyphicon glyphicon-education"> </span><label style="margin-left: 5px;"> Course Name :</label></div><span></span>
        ...
        <div class="col-sm-12" style="margin-bottom: 20px;margin-left: -4px;"">
          ...
          <div class="col-sm-8 col-xs-8" >
            <div class="form-group">
              <select class="form-control" name="subname" style="width:58%;">
              ...
              ?>
   			...
   			<div class="col-sm-12" style="margin-bottom: 20px; margin-left: -6px;"> 
   				...
   				<div class="col-sm-8 col-xs-8"><input type="text" name="message" class="form-control" style=" height: 150px; width:60% ">
