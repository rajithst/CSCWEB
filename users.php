                                ...
                                <div class="box-body table-responsive no-padding">
                                    ...
                                    <table class="table table-striped table-bordered" id="myDatatable" width="100%">
                                        ...
                                        echo "<tr>";
                                            ...
                                            echo "<td style='text-align: center'><a href=\"delete.php?id=".$row['id']."\"> Edit</a></td>";
                                            echo "<td style='text-align: center'><a href=\"update.php?id=".$row['id']."\">Delete</a></td>";
                                            echo '</tr>';
