				...
				<div class="row content"style="padding-top:0.1px;">	
						<div class="well" id="news">	
							...
							<?php
								...
								echo "<tr><td>Expense type</td><td>Description</td><td>Given to</td><td>Given by</td><td>Given date</td><td>Amount</td></tr>";
								while($row = mysqli_fetch_array($result)){   //Creates a loop to loop through results
								echo "<tr><td>" . $row['expense_type'] . "</td><td>" . $row['description'] . "</td><td>" . $row['given_to'] . "</td><td>" . $row['given_by'] . "</td><td>" . $row['given_date'] . "</td><td>" . $row['amount'] . "</td></tr>";  //$row['index'] the index here is a field name
								}
