        ...
        <div class="row content" style="padding-top:0.1px" >
            ...
            <div class="col-md-6 col-sm-12 col-xs-12" style="padding-right:0.1px;padding-left:0.1px;">
				...
				<u><b><h4>Select report type</h4></b></u>				
					<li>
					<a href="project_in.php"  style="color:white;font-size:17px;">
					...
					<br>
					<li>
					<a href="customized_courses_in.php"  style="color:white;font-size:17px;">
					...
					<br>
					<li>
					<a href="other_in.php"  style="color:white;font-size:17px;">
