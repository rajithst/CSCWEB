									...
									if($row['batch']!=null)
									{
										...
										while($i<=$row['batch'])
										{
											...
											<div class="process-step">
												 <a href="ex_marks.php?subid='.$subid.'&token='.$i.'">
                   ...
                   <h4><b>Subject : <?php echo "<i>".$subdata[2]."</i>"; ?></b></h4>
                    ...
                    <div class="box" style="width:75%;">
                        ...
                        <div class="box-body table-responsive no-padding">
                            ...
                            <button type="submit" class="btn btn-block btn-success btn-md" name="next"><b>Record Marks </b><span class="glyphicon glyphicon-ok"></span></button>
        ...
        <div class="col-md-4"></div>
			...
			if(isset($_POST['next']) === true) {
				...
				foreach ($_POST['marks'] as $index => $val)
				{
					$n=$_POST['name'];
					$new=$_POST['marks'];
					$sql = "UPDATE student SET exam_marks='$new[$i]' WHERE fullname = '$n[$i]'" ;
