				...
				<u><h2>PROJECT INCOME</h2></u>
                    ...
                    <table>
						<tr>
							...
							<td><input type="text"required id="enter_details" class="form-control"style="width:400px;"></input></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input type="date"required id="enter_details" ></input></td>
						</tr>
						<tr>
							<td><h4><b>Received by:-</b></h4></td>
							<td><input type="text"required id="enter_details" style="width:400px;" class="form-control"></input></td>
						</tr>
						<tr>
							<td><h4><b>Total income:-</b></h4></td>
							<td><input type="text"required id="enter_details" class="form-control"></input></td>
						</tr>
