...
<div class="container-fluid text-center">
        <div class="row content" style="padding-top:0.1px" >
            ...
            <div class="col-md-6 col-sm-12 col-xs-12" style="padding-right:0.1px;padding-left:0.1px;">
				...
				<u><h2>STUDENTS MARKS REPORT</h2></u>
                    ...
                    <table>
						...
						<tr>
							...
							<td>
								<div class="radio">
									<label><input type="radio" name="optradio">Asssignment</label>
									<label><input type="radio" name="optradio">Exam</label>
								</div>
							</td>
						</tr>
						<tr>
							<td><h4><b>Assignment number :-</b></h4></td>
							<td><input type="text "required id="enter_details" style="width:400px;"placeholder="If assignment enter the assignment number"></input></td>
						</tr>
						<tr>
							<td><h4><b>Wanted format</b></h4></td>
							<td>
								<div class="radio">
									<label><input type="radio" name="optradiox">On screen</label>
									<label><input type="radio" name="optradiox">PDF</label>
								</div>
							</td>
						</tr>
					</table>
