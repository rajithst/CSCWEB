        ...
        <div class="row content" style="padding-top:0.1px" >
            ...
            <div class="col-md-6 col-sm-12 col-xs-12" style="padding-right:0.1px;padding-left:0.1px;">
				...
				<u><h2>INCOME REPORT</h2></u>
                    ...
                    <table>
						<tr>
							<td><h4><b>Select income type:-</b></h4></td>
							<td style="width:200px;">
										<select style="width:200px;"class="form-control" id="selecting" name="type">
											<option value="project_income">Project income</option>
											<option value="cus_course_income">customized course income</option>
											<option value="course_income">Course fee income</option>
