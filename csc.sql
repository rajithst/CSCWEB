...
(1, NULL, 'Rajith Sanjeewa Thennakoon', 'T.M.R.S Thennakoon', 'csc02/1', '1994 05 01', 'male', '941221327V', '', '', 0, NULL, '', 0, '', NULL, '', NULL, 'csc@gmail.com', 'rajith@gmail.com', 14, 15, 1, '1', 0, 0, 0),
...
(3, NULL, 'Emalsha Rasad', 'E.R Rasad', 'csc02/1', NULL, NULL, '941221324V', '', '', 0, NULL, '', 0, '', NULL, '', NULL, 'csc@gmail.com', '', 12, 15, 1, '2', 0, 0, 0),
...
INSERT INTO `submissions` (`id`, `subid`, `linktitle`, `description`, `edateandtime`, `path`) VALUES
(4, 'csc02/4', 'Python Assignment', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.', '1479407100', '../uploads/assignment/'),
(5, 'csc02/1', 'a', 'a', '', '../uploads/mkdirlol/');
