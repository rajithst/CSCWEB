...
--
-- Host: localhost
-- Generation Time: Jan 15, 2017 at 02:24 PM
...
(12, 'ass', 'ss', 'ss', 'ss', 'Java Application Development using JavaSE');
...
INSERT INTO `lecture_details` (`subject_id`, `date`, `hall`, `time_from`, `time_to`, `lecturer_name`, `instructor_name`) VALUES
...
(2, 'Suneth', 'Perera', 'suneth@gmail.com', '0771648528', ' lorem', '5f4dcc3b5aa765d61d8327deb882cf99', 'Course Coordinator', '../public/dist/img/system/staff.jpg'),
...
(1, NULL, 'Rajith Sanjeewa Thennakoon', 'T.M.R.S Thennakoon', 'csc02/1', '0000-00-00', 'male', '941221327V', '', '', 0, NULL, '', 0, '', NULL, '', NULL, 'csc@gmail.com', 'rajith@gmail.com', 27, 29, 1, 1, 16, 2, 80),
...
(3, NULL, 'Emalsha Rasad', 'E.R Rasad', 'csc02/1', NULL, NULL, '941221324V', '', '', 0, NULL, '', 0, '', NULL, '', NULL, 'csc@gmail.com', '', 29, 34, 1, 1, 14, 2, 59),
...
ALTER TABLE `posts`
  ADD PRIMARY KEY (`id`),
  ADD KEY `posts_adminusers_id_fk` (`adminid`);
...
ALTER TABLE `subjects`
  ADD PRIMARY KEY (`id`),
  ADD KEY `subjects_courses_courseid_fk` (`courseid`),
  ADD KEY `subjects` (`coursecid`);
